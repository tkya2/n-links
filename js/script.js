...
$(function () {
  ...
  var topTitle = document.getElementsByClassName('top-title'); 
  var x = topTitle.length
  //開閉用ボタンをクリックでクラスの切替え
  $('#js__btn').on('click', function () {
      $body.toggleClass('open');
      for( i = 0; i < x ; i++ ){
        topTitle[i].style.opacity = '0';
      }
...
$(function(){
  ScrollReveal().reveal('.puroduct-content-container h2', 
  { delay: 120, 
    distance: '1px', 
    duration:2000,
    scale:4,
